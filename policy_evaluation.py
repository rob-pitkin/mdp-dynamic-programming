...
def policy_evaluation(policy: Dict[str, any], state_values: any, mdp: Dict[str, any], epsilon: float = 0.0):
    """
    ...
    try:
        ...
        for i in range(len(state_values)):
            ...
            for action, action_probability in policy[state]:
                ...
                value += action_probability * (mdp['r'][(state, action)] + mdp['y'] * next_state_values)
